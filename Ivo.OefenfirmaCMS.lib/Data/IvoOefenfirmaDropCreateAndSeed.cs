...
{
    internal class IvoOefenfirmaInitializer :
        MigrateDatabaseToLatestVersion<IvoOefenfirmaContext, Ivo.OefenfirmaCMS.lib.Migrations.Configuration>
    {

    }

    //public class IvoOefenfirmaInitializer : DropCreateDatabaseIfModelChanges<IvoOefenfirmaContext>
    //{

    //}

    public class IvoOefenfirmaDropCreateAndSeed : DropCreateDatabaseIfModelChanges<IvoOefenfirmaContext>
    {


        protected override void Seed(IvoOefenfirmaContext context)
        {
            ...
            List<Categorie> categorieën = new List<Categorie>
        {
            ...
            //new Categorie { Categorienaam = "Behuizingen" ,     ParentCategory = new Categorie{Categorienaam = "Componenten"}},
            //new Categorie { Categorienaam = "DVD/Blu Ray" ,     ParentCategory =new Categorie{Categorienaam = "Componenten"}},
            //new Categorie { Categorienaam = "Geheugen",         ParentCategory =new Categorie{Categorienaam = "Componenten"} },
            //new Categorie { Categorienaam = "Geluidskaarten" ,  ParentCategory =new Categorie{Categorienaam = "Componenten"}},
            //new Categorie { Categorienaam = "Harde schijven" ,  ParentCategory =new Categorie{Categorienaam = "Componenten"}},
            //new Categorie { Categorienaam = "Moederborden" ,    ParentCategory = new Categorie{Categorienaam = "Componenten"}},
            //new Categorie { Categorienaam = "Processoren" ,     ParentCategory = new Categorie{Categorienaam = "Componenten"}},
            //new Categorie { Categorienaam = "Video & TV-kaarten" , ParentCategory = new Categorie{Categorienaam = "Componenten"}},
            //new Categorie { Categorienaam = "Voedingen",        ParentCategory =new Categorie{Categorienaam = "Componenten"}},
            //new Categorie { Categorienaam = "Tablets",          ParentCategory =new Categorie{Categorienaam = "Laptop & PC"}  },
            //new Categorie { Categorienaam = "Apple",            ParentCategory = new Categorie{Categorienaam = "Laptop & PC"} },
            //new Categorie { Categorienaam = "Laptops",          ParentCategory =new Categorie{Categorienaam = "Laptop & PC"}  },
            //new Categorie { Categorienaam = "Desktop PC’s",     ParentCategory = new Categorie{Categorienaam = "Laptop & PC"}},
            //new Categorie { Categorienaam = "Routers",          ParentCategory =new Categorie{Categorienaam = "Netwerk" } },
            //new Categorie { Categorienaam = "Switchen",         ParentCategory = new Categorie{Categorienaam ="Netwerk" }},
            //new Categorie { Categorienaam = "Netwerkkaarten",   ParentCategory = new Categorie{Categorienaam = "Netwerk" }},
            //new Categorie { Categorienaam = "Inkjet printers",  ParentCategory =new Categorie{Categorienaam =  "Printen/Scannen" } },
            //new Categorie { Categorienaam = "Laserprinters",    ParentCategory =new Categorie{Categorienaam = "Printen/Scannen" }  },
            //new Categorie { Categorienaam = "Scanners",         ParentCategory =new Categorie{Categorienaam = "Printen/Scannen"}},
            //new Categorie { Categorienaam = "Externe dataopslag", ParentCategory =new Categorie{Categorienaam = "Randapparatuur"} },
            //new Categorie { Categorienaam = "Monitoren / Touchscreens", ParentCategory = new Categorie{Categorienaam = "Randapparatuur"} },
            //new Categorie { Categorienaam = "Speakers / hoofdtelefoons", ParentCategory =new Categorie{Categorienaam = "Randapparatuur"}  },
            //new Categorie { Categorienaam = "Bedieningsapparatuur", ParentCategory = new Categorie{Categorienaam = "Randapparatuur"} },
            //new Categorie { Categorienaam = "Hewlet Packard",   ParentCategory =new Categorie{Categorienaam = "Servers"} },
            //new Categorie { Categorienaam = "Supermicro",       ParentCategory = new Categorie{Categorienaam = "Servers"} },
            //new Categorie { Categorienaam = "Netwerk opslag (NAS)", ParentCategory = new Categorie{Categorienaam = "Servers"} },
            //new Categorie { Categorienaam = "Adobe",            ParentCategory =new Categorie{Categorienaam = "Software"} },
            //new Categorie { Categorienaam = "Microsoft",        ParentCategory =new Categorie{Categorienaam = "Software"}  },
            //new Categorie { Categorienaam = "Antivirus",        ParentCategory = new Categorie{Categorienaam = "Software"} },

        //};

        //    categorieën.ForEach(c => context.Categorieen.Add(c));

        //    List<Product> products = new List<Product>();


        //    //Algemeen
        //    List<Product> products_randapparatuur = new List<Product>
        //{
        //    new Product {   Artikelnummer="RA-EX-0101",
        //                    Artikelnaam = "Samsung SE-208DB",
        //                    Artikelomschrijving="De SE-208DB/TSBS van Samsung is een Externe DVD-brander, welke via Mini USB wordt aangesloten. De SE-208DB/TSBS " +
        ...
        //                    Prijs=28.89M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Externe dataopslag")
        //    },
        //    new Product {   Artikelnummer="RA-EX-0102",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Externe dataopslag")
        //    },
        //    new Product {   Artikelnummer="RA-MO-0110",
        ...
        //                    FiguurURL="",
        //                    Prijs=177.99M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Monitoren / Touchscreens")
        //    },
        //    new Product {   Artikelnummer="RA-MO-0111",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Monitoren / Touchscreens")
        //    },
        //    new Product {   Artikelnummer="RA-AU-0120",
        ...
        //                    FiguurURL="",
        //                    Prijs=25.41M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Speakers / hoofdtelefoons")
        //    },
        //    new Product {   Artikelnummer="RA-AU-0121",
        //                    Artikelnaam = "Logitech Gaming"+
        //                                   " Headset G230 ",
        //                    Artikelomschrijving="G230 levert hoogwaardig stereogeluid zodat je van begin tot eind in de game kunt opgaan"+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Speakers / hoofdtelefoons")
        //    },
        //    new Product {   Artikelnummer="RA-EX-0200",
        //                    Artikelnaam = "Transcend JetFlash 500",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Externe dataopslag")
        //    },
        //    new Product {   Artikelnummer="RA-EX-0201",
        //                    Artikelnaam = "Transcend JetFlash 500 Mobile",
        //                    Artikelomschrijving="Houd je data volledig beschermd met de Transcend StoreJet 25M2 portable harde schijf. Door middel"+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Externe dataopslag")
        //    },
        //    new Product {   Artikelnummer="RA-MO-0202",
        //                    Artikelnaam = "Dell UltraSharp U2312HM",
        //                    Artikelomschrijving="De Dell UltraSharp U2312HM is een genot voor je ogen. Door de IPS-techniek geniet je van kristalheldere kleuren en dit is vanuit"+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Monitoren / Touchscreens")
        //    },
        //     new Product {   Artikelnummer="RA-MO-0203",
        //                    Artikelnaam = "Dell UltraSharp U2713HM",
        //                    Artikelomschrijving="De 27” UltraSharp U2713HM monitor bidet helderheid van bioscoopniveau. Blijf productief dankzij de instellingen"+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Monitoren / Touchscreens")
        //    },
        //    new Product {   Artikelnummer="RA-AU-0204",
        //                    Artikelnaam = "Fantec SHS-221BT-RD Bluetooth Headphones",
        //                    Artikelomschrijving="De draadloze SHS-221BT stereo-headset van Fantec geeft u tot wel tien meter bewegingsvrijheid dankzij"+
        //                                        " Bluetooth-technologie",
        //                    FiguurURL=@"Content/images/RA-AU-0204.jpg",
        //                    Prijs=32.55M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Speakers / hoofdtelefoons")
        //    },
        //    new Product {   Artikelnummer="RA-AU-0205",
        //                    Artikelnaam = "SteelSeries Siberia V2",
        //                    Artikelomschrijving="De SteelSeries Siberia v2 Full-size Headset, is een licht-gewicht gaming headset, met een intrekbare microfoon."+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Speakers / hoofdtelefoons")
        //    },
        //     new Product {   Artikelnummer="RA-EX-300",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Externe dataopslag")
        //    },
        //    new Product {   Artikelnummer="RA-EX-301",
        //                    Artikelnaam = "LaCie d2 Quadra"+
        //                                      " V3 2 TB USB 2.0/800/ e SATA",
        //                    Artikelomschrijving="Met de USB 3,0- interface van 5GB/s is de LaCie d2 Quadra Hard Disk het ideale"+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Externe dataopslag")
        //    },
        //    new Product {   Artikelnummer="RA-MO-302",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Monitoren / Touchscreens")
        //    },
        //    new Product {   Artikelnummer="RA-MO-303",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Monitoren / Touchscreens")
        //    },
        //    new Product {   Artikelnummer="RA-AU-304",
        //                    Artikelnaam = "Stereo headset HS-2100"+
        //                                  " Trust",
        //                    Artikelomschrijving="Stereo headset met verstelbare microfoon,handsfree videoconferencing, chatten,"+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Speakers / hoofdtelefoons")
        //    },
        //    new Product {   Artikelnummer="RA-AU-305",
        //                    Artikelnaam = "SteelSeries 7H USB"+
        //                                  " Headset zwart",
        //                    Artikelomschrijving="De SteelSeries 7H USB versie biedt 7,1 Virtual surround en zorgt ervoor dat games"+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Speakers / hoofdtelefoons")
        //    },
        //    new Product {   Artikelnummer="RA-AU-306",
        //                    Artikelnaam = "Creative Speaker D80Bluetooth (zwart )",
        //                    Artikelomschrijving="Vervang u bedraade luidsprekers door de Creative D80 ,een compacte draadloze"+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Speakers / hoofdtelefoons")
        //    },
        //    new Product {   Artikelnummer="RA-AU-307",
        //                    Artikelnaam = "Sony Speaker NS410.LAN,WLAM"+
        //                                  " zwart",
        //                    Artikelomschrijving="2 weg WI-FI-luidsprekerssysteem met 5 luidsprekers,4x tweeteren 1x roofer van 110mm"+
        //                                           "  AirPlay,volledig directioneel geluid(360°)",
        //                    FiguurURL=@"Content/images/RA-AU-307.jpg",
        //                    Prijs=183M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Speakers / hoofdtelefoons")
        //    },
        //    new Product {   Artikelnummer="RA-IN-0819",
        //                    Artikelnaam = "Logitech Wireless Combo MK270 AZERTY",
        //                    Artikelomschrijving="Met deze draadloze Logitech Wireless Combo heb je tot wel 10 meter bereik, "+
        ...
        //                    Prijs= 39.95M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Bedieningsapparatuur")
        //    },
        //    new Product {   Artikelnummer="RA-IN-0820",
        //                    Artikelnaam = "Logitech G19S Gaming Toetsenbord Azerty",
        //                    Artikelomschrijving="Dit toetsenbord zit boordevol extra's om tijdens het gamen boven je tegenstan-"+
        ...
        //    }
        //};
        //    products.AddRange(products_randapparatuur);

            //Laptop & PC
        //    List<Product> products_laptopEnPc = new List<Product>
        //{
        //    new Product {   Artikelnummer="PC-TB-0130",
        ...
        //                    Prijs=583.16M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Tablets")
        //    },
        //    new Product {   Artikelnummer="PC-TB-0131",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Tablets")
        //    },
        //    new Product {   Artikelnummer="PC-AP-0140",
        ...
        //                    Prijs=378M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Apple")
        //    },
        //    new Product {   Artikelnummer="PC-AP-0141",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Apple")
        //    },
        //    new Product {   Artikelnummer="PC-LT-0150",
        ...
        //                    Prijs=578M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Laptops")
        //    },
        //    new Product {   Artikelnummer="PC-LT-0151",
        //                    Artikelnaam = "HP ProBook 450 G0"+
        //                                  " Core i5 3230M / 2.6 GHz",
        //                    Artikelomschrijving="HP ProBook 450 G0 - 15.6'' - Core i5 3230M - downgrade van Windows 7 Pro 64-bit naar"+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Laptops")
        //    },
        //    new Product {   Artikelnummer="PC-PC-0160",
        //                    Artikelnaam = "HP 600B "+
        //                                 "  Microtowermodel",
        ...
        //                    Prijs=392.25M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Desktop PC’s")
        //    },
        //    new Product {   Artikelnummer="PC-PC-0161",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Desktop PC’s")
        //    },
        //    new Product {   Artikelnummer="PC-TB-0206",
        //                    Artikelnaam = "Samsung Galaxy Tab 2  (7.0) WIFI",
        //                    Artikelomschrijving="Met de krachtige 1 GHz dual core processor van de Samsung Galaxy Tab 7.0 is multitasken geen probleem. "+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Tablets")
        //    },
        //    new Product {   Artikelnummer="PC-AP-0208",
        //                    Artikelnaam = "Apple MacBook Air",
        //                    Artikelomschrijving="Met de superefficiënte processors in MacBook Air heb je meer tijd om nog meer voor elkaar te krijgen." +
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Apple")
        //    },
        //    new Product {   Artikelnummer="PC-AP-0209",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Apple")
        //    },
        //    new Product {   Artikelnummer="PC-LT-0211",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Laptops")
        //    },
        //    new Product {   Artikelnummer="PC-PC-0212",
        //                    Artikelnaam = "Hp 600B",
        //                    Artikelomschrijving="De HP 600B MT biedt u de hoge prestaties die nodig zijn voor processor- en grafisch-intensieve applicaties en"+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Desktop PC’s")
        //    },
        //    new Product {   Artikelnummer="PC-PC-0213",
        //                    Artikelnaam = "Azerty Aeolus Starter"+
        //                                  " I2012W8",
        //                    Artikelomschrijving="De AZERTY Aeolus I2012W8 Starter is een eenvoudige PC voor het uitvoeren van de dagelijkse computertaken."+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Desktop PC’s")
        //    },
        //    new Product {   Artikelnummer="PC-TB-308",
        //                    Artikelnaam = "Samsung Galaxy Tab 27.0P3110.7.o\""+
        //                                  " zilver",
        //                    Artikelomschrijving="Deze tablet is ideaal voor onderweg. Dankzij het verassend lichte gewicht van de "+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Tablets")
        //    },
        //    new Product {   Artikelnummer="PC-TB-309",
        //                    Artikelnaam = "HP Elitepad 900 D4T1544",
        //                    Artikelomschrijving="De zakelijke HP ElitePad 900 D4T15AA is een tablet met een 10,1 inch touchscreen."+
        ...
        //    }
        //};
        //    products.AddRange(products_laptopEnPc);

        //    //Servers
        //    List<Product> products_servers = new List<Product>
        //{
        //    new Product {   Artikelnummer="PC-TB-309",
        ...
        //                    FiguurURL=@"Content/images/PC-TB-309.jpg",
        //                    Prijs=224.9M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Hewlet Packard")
        //    },
        //    new Product {   Artikelnummer="SV-HP-0171",
        //                    Artikelnaam = "HP ProLiant DL360e "+
        //                                   "Gen8 Entry - Server",
        //                    Artikelomschrijving="rack-uitvoering - 1U - 2-weg - 1 x Xeon E5-2403 / 1.8 GHz - RAM 4 GB - SATA"+
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Hewlet Packard")
        //    },
        //    new Product {   Artikelnummer="SV-SM-0180",
        ...
        //                    Prijs=415.96M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Supermicro")
        //    },
        //    new Product {   Artikelnummer="SV-SM-0181",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Supermicro")
        //    },
        //    new Product {   Artikelnummer="SV-NS-0190",
        ...
        //                    Prijs= 648.9M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Netwerk opslag (NAS)")
        //    },
        //    new Product {   Artikelnummer="SV-NS-0191",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Netwerk opslag (NAS)")
        //    },
        //    new Product {   Artikelnummer="SV-HP-0214",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Hewlet Packard")
        //    },
        //    new Product {   Artikelnummer="SV-HP-0215",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Hewlet Packard")
        //    },
        //    new Product {   Artikelnummer="SV-SM-0216",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Supermicro")
        //    },
        //    new Product {   Artikelnummer="SV-SM-0217",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Supermicro")
        //    },
        //    new Product {   Artikelnummer="SV-NS-0218",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Netwerk opslag (NAS)")
        //    },
        //    new Product {   Artikelnummer="SV-NS-0219",
        ...
        //};
        //    products.AddRange(products_servers);

        //    //Netwerk
        //    List<Product> products_netwerk = new List<Product>
        //{
        //    new Product {   Artikelnummer="NW-RT-0401",
        ...
        //                    Prijs=179.99M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Routers")
        //    },
        //    new Product {   Artikelnummer="NW-RT-0402",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Routers")
        //    },
        //    new Product {   Artikelnummer="NW-SW-0403",
        ...
        //                    Prijs=74.95M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Switchen")
        //    },
        //    new Product {   Artikelnummer="NW-SW-0404",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Switchen")
        //    },
        //    new Product {   Artikelnummer="NW-NC-0405",
        ...
        //                    Prijs=29.89M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Netwerkkaarten")
        //    },
        //    new Product {   Artikelnummer="NW-NC-0406",
        ...
        //    }
        //};
        //    products.AddRange(products_netwerk);

        //    //Software
        //    List<Product> products_software = new List<Product>
        //{
        //    new Product {   Artikelnummer="SW-AD-0407",
        ...
        //                    Prijs=207.01M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Adobe")
        //    },
        //    new Product {   Artikelnummer="SW-AD-0408",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Adobe")
        //    },
        //    new Product {   Artikelnummer="SW-MS-0409",
        ...
        //                    Prijs=139M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Microsoft")
        //    },
        //    new Product {   Artikelnummer="SW-MS-0411",
        ...
        //                    Prijs=49.99M,
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Antivirus")
        //    },
        //    new Product {   Artikelnummer="SW-AV-0410",
        ...
        //                    Categorie = categorieën.Single(c => c.Categorienaam == "Microsoft")
        //    },
        //    new Product {   Artikelnummer="SW-AV-0412",
        ...
        //    }
        //};
        //    products.AddRange(products_software);

    //        //Printen/Scannen
    //        List<Product> products_printenEnScannen = new List<Product>
    //    {
    //    new Product
    //    {
    ...
    //        Prijs = 159M,
    //        Categorie = categorieën.Single(c => c.Categorienaam == "Inkjet printers")
    //    },
    //    new Product
    //    {
    ...
    //        Prijs = 99M,
    //        Categorie = categorieën.Single(c => c.Categorienaam == "Laserprinters")
    //    },
    //    new Product
    //    {
    ...
    //        Prijs = 60M,
    //        Categorie = categorieën.Single(c => c.Categorienaam == "Scanners")
    //    },
    //    new Product
    //    {
    ...
    //    }
    //    };
    //        products.AddRange(products_printenEnScannen);

    //        //Componenten
    //        List<Product> products_componenten = new List<Product>
    //    {
    //    new Product
    //    {
    //        Artikelnummer = "CM-BE-0801",
    //        Artikelnaam = "Cooler Master K-280",
    //        Artikelomschrijving = "De Cooler Master K-280 computerbehuizing beschikt over 1 vooraf geïnstalleerde" +
    ...
    //        Prijs = 44.95M,
    //        Categorie = categorieën.Single(c => c.Categorienaam == "Behuizingen")
    //    },
    //    new Product
    //    {
    ...
    //        Artikelomschrijving = "De Asus Blu-ray Brander is in staat om blu-ray schijven te branden tot een grote" +
    ...
    //        Prijs = 119.95M,
    //        Categorie = categorieën.Single(c => c.Categorienaam == "DVD/Blu Ray")
    //    },
    //    new Product
    //    {
    ...
    //        Prijs = 84.95M,
    //        Categorie = categorieën.Single(c => c.Categorienaam == "Geheugen")
    //    },
    //    new Product
    //    {
    ...
    //        Artikelomschrijving = "Deze geluidskaart maakt gebruik van Dolby Home Theater technologieën, om een" +
    ...
    //        Prijs = 74.95M,
    //        Categorie = categorieën.Single(c => c.Categorienaam == "Geluidskaarten")
    //    },
    //    new Product
    //    {
    //        Artikelnummer = "CM-GL-0808",
    //        Artikelnaam = "Asus Xonar Essence STX",
    //        Artikelomschrijving = "Deze geluidskaart levert tot wel 64 keer zuiverder geluid dan een onboard ge-" +
    ...
    //        Artikelomschrijving = "Seagate is al sinds 1979 actief in de harddisk-branche en staat nog steeds vooraan" +
    ...
    //        Prijs = 189M,
    //        Categorie = categorieën.Single(c => c.Categorienaam == "Harde schijven")
    //    },
    //    new Product
    //    {
    //        Artikelnummer = "CM-HD-0810",
    //        Artikelnaam = "WD Blue WD7500LPCX 750 GB",
    //        Artikelomschrijving = "Deze WD Blue-harde schijf heeft het 2,5 inch-formaat en biedt goede prestaties" +
    ...
    //        Prijs = 87.95M,
    //        Categorie = categorieën.Single(c => c.Categorienaam == "Moederborden")
    //    },
    //    new Product
    //    {
    ...
    //        Artikelomschrijving = "De Intel Core beschikt over 6-Core technologie, maar liefst 12 MB cache en een" +
    ...
    //        Prijs = 529.95M,
    //        Categorie = categorieën.Single(c => c.Categorienaam == "Processoren")
    //    },
    //    new Product
    //    {
    ...
    //        Prijs = 44.95M,
    //        Categorie = categorieën.Single(c => c.Categorienaam == "Video & TV-kaarten")
    //    },
    //    new Product
    //    {
    //        Artikelnummer = "CM-VC-0816",
    //        Artikelnaam = "MSI N780 Lightning",
    //        Artikelomschrijving = "De MSI N780 Lightning is gebaseerd op de zeer krachtige Nvidia GeForce GTX 780" +
    ...
    //        Prijs = 49.95M,
    //        Categorie = categorieën.Single(c => c.Categorienaam == "Voedingen")
    //    },
    //    new Product
    //    {
    ...
    //        products.AddRange(products_componenten);

    //        products.ForEach(p => context.Producten.Add(p));
    //        base.Seed(context);
    //    }
    }
